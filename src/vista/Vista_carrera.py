...
class Vista_carrera(QWidget):
    ...
    def guardar_cambios(self):
        ...
        """    
        resultado = self.interfaz.guardar_carrera(self.texto_nombre.text(), self.competidores)
        if (resultado):
            ...
            self.mensaje_generar("Error Carrera", "Error al crear la carrera. \n-La carrera debe tener un nombre y debe ser único para cada carrera. \n-La sumatoria de las probabilidades debe ser igual a 1. \n-Debe existir más de un competidor para crear la carrera.")
            self.mostrar_competidores(self.texto_nombre.text(), self.competidores)   
